...
.controller('TableCtrl', ['deckFactory', 'playerFactory', 'RESULT_MESSAGES', 'WINNING_POINTS', 'MAXIMUM_POINTS', 'PLAYERS',
   function (deckFactory, playerFactory, RESULT_MESSAGES, WINNING_POINTS, MAXIMUM_POINTS, PLAYERS) {
       ...
       /**
         ...
         * @name startRound
         * @methodOf TableCtrl
         * @description Creates a deck of cards for this game.
         */
         ...
         * @name createPlayers
         * @methodOf TableCtrl
         * @description Creates the defined players.
         */
        this.createPlayers = function () {
            ...
            for (key in PLAYERS) {
                if (PLAYERS.hasOwnProperty(key)) {
                    player = PLAYERS[key];
                    this.players[key] = playerFactory.build(
                        player.name,
                        player.showPoints
                    );
                }
         ...
         * @name setUpTable
         * @methodOf TableCtrl
         * @description Initial table set up.
         */
